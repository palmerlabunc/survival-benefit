...
def main():
    ...
    n_patients = 20
    mono = get_weibull_survival_dataframe(1, 8, n_patients)
    comb = get_weibull_survival_dataframe(1, 16, n_patients)

    mono_u = get_weibull_survival_dataframe(1, 8, 1000)
    comb_u = get_weibull_survival_dataframe(1, 16, 1000)
